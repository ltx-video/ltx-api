...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/lightricks/ltx-2.5-pro)
...
> **Try it now:** [https://synexa.ai/explore/lightricks/ltx-2.5-pro](https://synexa.ai/explore/lightricks/ltx-2.5-pro) — the hosted model behind this client. New accounts get a free trial credit.
...
|---|---|---|---|
| [`lightricks/ltx-2.5-pro`](https://synexa.ai/explore/lightricks/ltx-2.5-pro) | image-to-video | LTX-2.5 Pro animates a still image into video with synchronised audio and optional camera moves. | $0.12 |
| [`lightricks/ltx-2.5-audio-to-video`](https://synexa.ai/explore/lightricks/ltx-2.5-audio-to-video) | audio-to-video | LTX-2.5 Pro generates video timed to a supplied audio track, optionally starting from an image. | $0.17 |
